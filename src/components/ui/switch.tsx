...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "pointer-events-none block h-3.5 w-3.5 rounded-none ring-0 transition-transform data-[state=checked]:translate-x-[18px] data-[state=checked]:bg-primary data-[state=unchecked]:translate-x-0.5 data-[state=unchecked]:bg-muted-foreground"
      )}
    />
  </SwitchPrimitives.Root>
))
