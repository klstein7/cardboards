...
export default function DashboardMonoPage() {
  return (
    <div className="min-h-dvh bg-neutral-950 text-neutral-100">
      ...
      <main className="mx-auto max-w-6xl px-6 pb-24">
        <div className="flex flex-wrap items-end justify-between gap-6 pt-14">
          ...
          <button className="flex items-center gap-1.5 bg-white px-4 py-2 text-sm font-medium text-neutral-950 transition-colors hover:bg-neutral-300">
        ...
        <div className="mt-14 grid grid-cols-2 border-y border-neutral-800 md:grid-cols-4 md:divide-x md:divide-neutral-800">
          {dashboardStats.map((stat) => (
            <div key={stat.label} className="py-8 md:px-8 md:first:pl-0">
              ...
              <p className="mt-2 text-5xl font-extralight tracking-tight md:text-6xl">
                {stat.value}
              </p>
            </div>
          ))}
        ...
        <section className="mt-16">
          ...
          <div className="mt-2">
            {dashboardBoards.map((board) => (
              ...
              >
                <h3 className="text-2xl font-light tracking-tight transition-colors group-hover:text-white md:text-3xl">
                  {board.name}
                </h3>
