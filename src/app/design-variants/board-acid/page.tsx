...
function AcidBoardCard({ card }: { card: MockCard }) {
  return (
    <div
...
export default function BoardAcidPage() {
  return (
    <div className="flex h-dvh bg-neutral-950 text-neutral-100">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <div className="flex shrink-0 flex-wrap items-center gap-3 border-b border-neutral-800 px-5 py-3">
          <label className="flex h-8 w-56 items-center gap-2 border border-neutral-800 px-2.5 focus-within:border-lime-300/60">
              ...
              <section key={column.name} className="flex w-72 flex-col p-4">
                ...
                <div className="space-y-2">
                  {column.cards.map((card) => (
                    <AcidBoardCard key={card.title} card={card} />
                  ))}
                </div>
