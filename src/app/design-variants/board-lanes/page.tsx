...
export const metadata: Metadata = {
  title: "Lanes board variant | cardboards",
};
...
const labelFilters = ["Bug", "Feature", "Design", "Performance"];
...
function LaneCard({
  ...
  return (
    <div className="group relative -mx-5 cursor-pointer px-5 py-3 transition-colors hover:bg-primary/[0.04]">
...
export default function BoardLanesPage() {
  return (
    <VariantShell active="lanes">
        ...
        <div className="flex-1 overflow-x-auto">
          <div className="flex h-full w-fit items-stretch divide-x divide-border">
            {boardColumns.map((column) => (
              <div
                key={column.name}
                className="flex h-full w-[85vw] shrink-0 flex-col border-t-2 sm:w-[330px]"
